...
CleanShot Tool is the public OpenClaw Tool Plugin. A separate optional CleanShot Skill can provide workflow guidance outside this repository, but that skill layer is not included here.
